/**
 * constants.ts
 * Centralized app constants: URLs, JWT, Database, Account (Gmail, Google, Facebook).
 * Scope: backend user-service only.
 */
...
// Optional: chỉ cần khi bạn không nhúng password trong URI
